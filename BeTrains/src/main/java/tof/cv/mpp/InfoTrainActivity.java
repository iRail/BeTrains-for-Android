...
public class InfoTrainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bottomNavigation != null) {
             ...
             * R.drawable.ic_nav_plan, R.color.primarycolor);
             * item1.setTitle(name.replace("BE.NMBS.",""));
             * AHBottomNavigationItem item2 = new
             * AHBottomNavigationItem(R.string.activity_label_chat, R.drawable.ic_nav_chat,
             * R.color.primarycolor);
             * AHBottomNavigationItem item3 = new
             * AHBottomNavigationItem(R.string.activity_label_notif,
             * R.drawable.ic_nav_notif, R.color.primarycolor);
             * 
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    fragment.setInfo(InfoTrainActivity.this.name, InfoTrainActivity.this.fromTo,
                            InfoTrainActivity.this.timestamp);
                    return fragment;
                case 1:
