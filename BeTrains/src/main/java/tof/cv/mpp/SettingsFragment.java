...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onResume() {
        ...
        try {
            ...
            ((androidx.appcompat.app.AppCompatActivity) getActivity()).getSupportActionBar().setSubtitle(null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
        setPreferencesFromResource(R.xml.preferences_all, rootKey);
        ...
        if (android.preference.PreferenceManager.getDefaultSharedPreferences(getActivity()).getBoolean("google",
                false)) {
            getPreferenceScreen().findPreference("hidepic").setEnabled(true);
        ...
        if (pic.length() > 0) {
            Target target = new Target() {
                ...
                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                    getPreferenceScreen().findPreference("prefname")
        ...
        getPreferenceScreen().findPreference("donator")
                .setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        String mail = PreferenceManager.getDefaultSharedPreferences(getActivity())
                                .getString("prefmail", "X").replace(".", "");
                        FirebaseDatabase.getInstance().getReference().child("donator").child(mail)
