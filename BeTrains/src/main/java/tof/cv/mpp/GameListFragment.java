...
import tof.cv.mpp.Utils.BaseGameListFragment;
 ...
 */
public class GameListFragment extends BaseGameListFragment implements
        ...
        try {
            ...
            Games.Achievements.load(getApiClient(), false).setResultCallback(new ResultCallback<Achievements.LoadAchievementsResult>() {
                ...
                public void onResult(Achievements.LoadAchievementsResult loadAchievementsResult) {
                    ...
                    AchievementAdapter adapter = new AchievementAdapter(GameListFragment.this.getActivity(), R.layout.row_achieve, new ArrayList<Achievement>());
                    while (it.hasNext()) {
                        adapter.add(it.next());
                    }
                    ((StaggeredGridView) getView().findViewById(R.id.listAchivement)).setAdapter(adapter);
        ...
        Games.Leaderboards.loadPlayerCenteredScores(getApiClient(), LEADER, LeaderboardVariant.TIME_SPAN_WEEKLY, LeaderboardVariant.COLLECTION_PUBLIC, 25).setResultCallback(new ResultCallback<Leaderboards.LoadScoresResult>() {
            ...
            public void onResult(Leaderboards.LoadScoresResult loadScoresResult) {
                ...
                try {
                    ...
                    HighScoreAdapter adapter = new HighScoreAdapter(GameListFragment.this.getActivity(), R.layout.row_high, new ArrayList<LeaderboardScore>());
            ...
            public void run() {
                try {
                    if ((System.currentTimeMillis() < PreferenceManager
                            .getDefaultSharedPreferences(GameListFragment.this.getActivity())
                            .getLong("next", 0))) {
                        long delta = PreferenceManager.getDefaultSharedPreferences(
                                GameListFragment.this.getActivity()).getLong("next", 0)
                        ...
                        GameListFragment.this.getActivity().getActionBar().setTitle(
                    ...
                    if ((System.currentTimeMillis() > PreferenceManager
                        ...
                        SharedPreferences.Editor e = PreferenceManager
                                .getDefaultSharedPreferences(
                                        GameListFragment.this.getActivity()).edit();
