...
public class TipAdapter extends ArrayAdapter<RSSItem>{

	private LayoutInflater myLayoutInflater;
	private RSSFeed myRssFeed;
	
	public TipAdapter(Context context, int textViewResourceId,List<RSSItem> list,LayoutInflater layoutInflater,RSSFeed rssFeed) {
